              ...
              <div id="theme-options-wrapper">
                <div>
                  ...
                  <label className="label" htmlFor="switchDark">
                    ...
                    {/* --- NOW I have to flip them i had them wrong;bcuz they werent working */}
                    <i className="fa fa-sun-o"></i>
                    <i className="fa fa-moon-o"></i>
          ...
          <div className="about-wrapper">
            <div className="about-me">
              ...
              <p>
                ...
                myself. I want to be part of a team with like-minded people
      ...
      <section className="s1">
        <div className="main-container">
          ...
          <h6 style={{ textAlign: "center", marginTop: "0px" }}>
            ...
            alternatives to Heroku (<i>which removed free plans</i>).<br></br>
